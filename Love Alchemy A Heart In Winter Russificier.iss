...
; Всегда меняются
#define GameName "Love Alchemy A Heart In Winter"                                          ; Название игры
#define GameNameDash "Love-Alchemy-A-Heart-In-Winter"                                                          ; Название игры без пробелов
#define GameNameEXE "LoveAlchemy_AHeartInWinter"                                                              ; Название exe файла игры
#define GameVer "1.0"                                                                     ; Версия игры
#define GameAppIdSteam "1038650"                                                             ; Ид игры в стиме
;От ситуации зависит
...
#define Arciv "game.zip.001"

[Setup]
;Номер приложения для его удаление лучше все время не забывать разный совать. Проверка уникальный для: Love Alchemy: A Heart In Winter Russificier
AppId={{E7C5E4AA-2CF3-4B72-BE10-17E303738965}
